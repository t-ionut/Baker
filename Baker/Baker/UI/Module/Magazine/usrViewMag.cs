...
namespace Baker
{
    public partial class usrViewMag : UserControl
    {
        #region - Declarations
        ...
        public void ConnectGridToSource(DataTable dt, string RightClickMenu, DataGridViewAutoSizeColumnMode SizeMode)
        {
            ...
            dataGridView1.ContextMenuStrip = contextMenuGrid;
        }
        ...
        private void btnExportGrid_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                string pdfHeader = "Raport NovaPane" + "\n"
                                ...
                                + ((DataTable)dataGridView1.DataSource).TableName;
                pdf.SendToPDF(pdfHeader, pdfName, dataGridView1, dataGridView1.DataSource as DataTable);
        ...
        {
            int prodId = int.Parse(dataGridView1.CurrentRow.Cells[0].Value.ToString());
            string oldPftva = dataGridView1.CurrentRow.Cells[5].Value.ToString();
            string tva = dataGridView1.CurrentRow.Cells[6].Value.ToString();
