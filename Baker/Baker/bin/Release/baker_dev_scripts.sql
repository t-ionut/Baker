...
VALUES (1,'admin','ITXpIcjQKOBZgNtC7mZdmeRdU5g5/6mjQpsNDmAwqSQ=','Td0kVOmFwTYZw2tFIA4+zSzh2dJXhDmLgWEk68w4Kn8=','Admin','Admin',TRUE);
...
INSERT INTO app_tip_prod (nume_tip_prod)
VALUES ('Paine'),('Cozonac'),('Patiserie'),('Diverse');
...
CREATE OR REPLACE VIEW app_livrari_prod AS 
 ...
 SELECT app_livrari_prod.id_raport_livrare,
    ...
    sum(app_livrari_prod.cantitate_livrata::double precision * app_livrari_prod.pret_prod_ctva) - app_livrari_prod.suma_incasata AS rest_plata
